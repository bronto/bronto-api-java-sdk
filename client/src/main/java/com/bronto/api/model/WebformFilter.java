...
/**
 * <p>Java class for webformFilter complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="webformFilter">
 *   &lt;complexContent>
 ...
 *         &lt;element name="webformType" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "webformFilter", propOrder = {
    "type",
    "id",
    "name",
    "webformType"
...
public class WebformFilter {
    ...
    @XmlElement(nillable = true)
    protected List<String> webformType;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the webformType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWebformType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getWebformType() {
        if (webformType == null) {
            webformType = new ArrayList<String>();
        }
